...
/* f_Phi:(i0[7],i1[3],i2[3x2],i3[3x2])->(o0[15]) */
...
void mex_f_Phi(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+10, casadi_s2, w+37);
  if (--argc>=0) arg[3] = casadi_from_mex(argv[3], w+16, casadi_s2, w+37);
  --resc;
  res[0] = w+22;
