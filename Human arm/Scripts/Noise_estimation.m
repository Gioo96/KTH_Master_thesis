...
%         pause(0.1);
%     
%         addpoints(plotp.(sprintf('x%d', i)), m1.current_time, m1.meas_pos(1));
%         addpoints(plotp.(sprintf('y%d', i)), m1.current_time, m1.meas_pos(2));
%         addpoints(plotp.(sprintf('z%d', i)), m1.current_time, m1.meas_pos(3)); 
% 
%         addpoints(plotv.(sprintf('x%d', i)), m1.current_time, m1.meas_vel(1));
%         addpoints(plotv.(sprintf('y%d', i)), m1.current_time, m1.meas_vel(2));
%         addpoints(plotv.(sprintf('z%d', i)), m1.current_time, m1.meas_vel(3));
%         
%         if (n_samples == 0)
% 
...
%     m1.count = 0;
%     m1.current_time = 0;
%     m1.old_estimate_pos = zeros(3, 3);
%     m1.old_estimate_vel = zeros(3, 3);
%     i = i + 1;
%     position_top_left = [];
% 
% end
