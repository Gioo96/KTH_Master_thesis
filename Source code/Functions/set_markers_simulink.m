...
% set_markers_simulink sets the markers, in terms of cartesian coordinates, in Simulink

% Inputs:
% -- sh_markers : SHOULDER markers
% -- fo_markers : FOREARM markers
% -- ha_markers : HAND markers
