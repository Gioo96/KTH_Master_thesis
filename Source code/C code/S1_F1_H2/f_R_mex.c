...
#else
  #define CASADI_PREFIX(ID) f_R_mex_ ## ID
#endif
...
/* f_R:(i0[7],i1[3],i2[3],i3[3x2])->(o0[3x3]) */
...
CASADI_SYMBOL_EXPORT int f_R(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int f_R_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int f_R_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void f_R_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int f_R_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void f_R_release(int mem) {
}

CASADI_SYMBOL_EXPORT void f_R_incref(void) {
}

CASADI_SYMBOL_EXPORT void f_R_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int f_R_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int f_R_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real f_R_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* f_R_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* f_R_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* f_R_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* f_R_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int f_R_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
#ifdef MATLAB_MEX_FILE
void mex_f_R(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  casadi_real w[40];
  casadi_int *iw = 0;
  const casadi_real* arg[4] = {0};
  casadi_real* res[1] = {0};
  if (argc>4) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"f_R\" failed. Too many input arguments (%d, max 4)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"f_R\" failed. Too many output arguments (%d, max 1)", resc);
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+28);
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+7, casadi_s1, w+28);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+10, casadi_s1, w+28);
  if (--argc>=0) arg[3] = casadi_from_mex(argv[3], w+13, casadi_s2, w+28);
  --resc;
  res[0] = w+19;
  i = f_R(arg, res, iw, w+28, 0);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"f_R\" failed.");
  if (res[0]) resv[0] = casadi_to_mex(casadi_s3, res[0]);
}
#endif

casadi_int main_f_R(casadi_int argc, char* argv[]) {
  casadi_int j;
  casadi_real* a;
  const casadi_real* r;
  casadi_int flag;
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_f_R(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "f_R")==0) {
    mex_f_R(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'f_R'");
}
#endif
int main(int argc, char* argv[]) {
  if (argc<2) {
    /* name error */
  } else if (strcmp(argv[1], "f_R")==0) {
    return main_f_R(argc-2, argv+2);
  }
  fprintf(stderr, "First input should be a command string. Possible values: 'f_R'\nNote: you may use function.generate_input to create a command string.\n");
  return 1;
}
#ifdef __cplusplus
} /* extern "C" */
